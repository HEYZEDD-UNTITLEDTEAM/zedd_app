...
class Latelogin extends StatelessWidget {
  const Latelogin({super.key});
          ...
          children: [
            Center(
             child: Row(
              ...
              children: [
                Image(image: AssetImage("assets/Z-img.png"),height: screenHeight*0.2,width: screenWidth*0.2,),
                SizedBox(width: 10,),
                Text("Zedd",style: TextStyle(color: Colors.white,fontSize: 32),)
              ],
             ),
            ),
            Positioned(
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  height: 200, // Fixed height for the overlay
